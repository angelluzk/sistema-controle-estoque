    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Editar Produto</h1>
            </div>
        </header>
        <main>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-4">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="nome" id="nome" required value="<?= htmlspecialchars($produto['nome']) ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="sku" id="sku" value="<?= htmlspecialchars($produto['sku']) ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="number" step="0.01" name="preco" id="preco" required value="<?= htmlspecialchars($produto['preco']) ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="number" name="quantidade" id="quantidade" required value="<?= htmlspecialchars($produto['quantidade']) ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <select id="categoria_id" name="categoria_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300">
